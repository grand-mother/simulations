...
# Usage: python GetAntennas_mountainSlope.py 83 40 10 1.0 CR_0
# (zenith, azimuth, slope, energy, name)
...
def computeAntennaPos(zenith, azimuth, alpha, energy, dist_fromxmax, name):
  ...
  # inside Zhaires a conversion to zaxis down is made
    ...
    #distance antenna array to xmax, should be a parameter handed over
